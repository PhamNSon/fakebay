...
class BidsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'bid_price' => ['type' => 'float', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'status' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '1 - Win; 2 - Lost; 3 - Still Bidding; 
4 - Done', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'bid_price' => 1,
            'status' => 1,
            'created' => '2017-03-07 01:56:49',
            'modified' => '2017-03-07 01:56:49'
        ],
    ];
}
